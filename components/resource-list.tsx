            ...
            {Array.from({ length: 6 }).map((_, i) => {
                return (
                    <article key={i} className="flex animate-pulse flex-col gap-2 p-2">
                        <span
                            id="image"
                            className="h-[25vh] w-full rounded-2xl bg-muted-light"></span>
                        ...
                        <span id="description" className="flex w-full flex-col gap-2 rounded-2xl">
                            <span
                                id="text-line"
                                className="h-4 w-full rounded-2xl bg-muted-light"></span>
                            <span
                                id="text-line"
                                className="h-4 w-full rounded-2xl bg-muted-light"></span>
                            <span
                                id="text-line"
                                className="h-4 w-1/2 rounded-2xl bg-muted-light"></span>
                        </span>
                    </article>
                );
            })}
